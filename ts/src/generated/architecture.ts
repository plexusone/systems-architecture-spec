...
export const ProtocolBindingSchema = z.object({ "id": z.string(), "protocolRef": z.string(), "participants": z.record(z.string(), z.string()) }).strict();
